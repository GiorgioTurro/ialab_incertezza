...
public class DynamicBayesNet extends BayesNet implements DynamicBayesianNetwork {
	...
	private Map<RandomVariable, Set<RandomVariable>> X_to_E = new HashMap<RandomVariable, Set<RandomVariable>>();
	...
	public DynamicBayesNet(BayesianNetwork priorNetwork, Map<RandomVariable, Set<RandomVariable>> X_to_E,
		...
		for (Map.Entry<RandomVariable, Set<RandomVariable>> x0_x1 : X_to_E.entrySet()) {
			RandomVariable x0 = x0_x1.getKey();
			Set<RandomVariable> listE = x0_x1.getValue();
			this.X_to_E.put(x0, listE);
		}
		this.E_1.addAll(E_1);
	...
	@Override
	public Map<RandomVariable, Set<RandomVariable>> getX_to_E() {
		return X_to_E;
	}
